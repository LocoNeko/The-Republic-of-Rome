 ...
 */
class Card extends \Entities\Card implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Entities\\Card' . "\0" . 'game', 'name', 'type', 'location_card', 'location_deck', '' . "\0" . 'Entities\\Card' . "\0" . 'cards_controlled');
        }
    ...
    public function resetLocation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'resetLocation', array());

        return parent::resetLocation();
    }
