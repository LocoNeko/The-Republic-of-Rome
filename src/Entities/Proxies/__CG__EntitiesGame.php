...
class Game extends \Entities\Game implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getAllMessages($user_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllMessages', array($user_id));

        return parent::getAllMessages($user_id);
    }
    ...
    public function getParty($user_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParty', array($user_id));

        return parent::getParty($user_id);
    }
    ...
    public function getPartiesNames()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPartiesNames', array());

        return parent::getPartiesNames();
    }
    ...
    public function getAllSenators($criteria = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllSenators', array($criteria));

        return parent::getAllSenators($criteria);
    }
